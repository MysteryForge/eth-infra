...
variable "prysm_pvc_size" {
  description = "The size of the prysm pvc"
  type        = string
}
...
variable "prysm_args" {
  description = "The arguments to pass to prysm, and make sure you dont owerwrite the data dir, jwt secret and ports"
  type        = list(string)
}
...
variable "prysm_image" {
  description = "The image to use for prysm"
  type        = string
}
