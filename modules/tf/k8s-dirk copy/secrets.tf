resource "kubernetes_secret" "dirk_config" {
  ...
  data = {
    "dirk.yml" = yamlencode({
      ...
      unlocker : {
        // account-passphrases is a list of passphrases that can be used to unlock wallets. Each entry is majordomo URL.
        account-passphrases : [
      ...
      process : {
        // generation-passphrase is the passphrase used to encrypt newly-generated accounts. It is majordomo URL.
